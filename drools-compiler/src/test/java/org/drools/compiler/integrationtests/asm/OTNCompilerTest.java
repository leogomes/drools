...
public class OTNCompilerTest extends CommonTestMethodBase {
	...
	public void test() {
        ...
        drl += "   Person(name == \"Leo\", happy == true)\n";
        drl += "then\n";
        drl += "end\n";
        ...
        CompiledNetwork compiledNetwork = ObjectTypeNodeCompiler.compile( ((KnowledgeBuilderImpl)kbuilder).getPackageBuilder(), otn ); 
	...
	protected KieBase loadKieBase(KnowledgeBuilder kbuilder, RuleEngineOption phreak, String... drlContentStrings) {
